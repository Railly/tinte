        ...
        <>
          <motion.div
            className={cn(
              ...
              indicatorType === "shadow" &&
                "bg-gradient-to-b from-background via-background/60 to-transparent shadow-md",
              indicatorType === "border" &&
                "bg-gradient-to-b from-background/80 to-transparent border-b border-border/40",
              indicatorType === "mask" &&
          ...
          <motion.div
            className={cn(
              ...
              indicatorType === "shadow" &&
                "bg-gradient-to-t from-background via-background/60 to-transparent shadow-md",
              indicatorType === "border" &&
                "bg-gradient-to-t from-background/80 to-transparent border-t border-border/40",
              indicatorType === "mask" &&
