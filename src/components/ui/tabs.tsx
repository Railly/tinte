...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
      className={cn("flex bg-background flex-col gap-2", className)}
      {...props}
    />
  );
}
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-transparent text-muted-foreground inline-flex w-fit items-center justify-center rounded-lg p-2",
        className,
      )}
      {...props}
    />
