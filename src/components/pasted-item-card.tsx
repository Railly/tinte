          ...
          {item.kind === 'image' && item.imageData ? (
            ...
            <div className="flex items-start gap-2 mb-2">
              ...
              <div className="min-w-0">
                <p className={`text-[8px] font-medium break-words leading-tight mb-1 ${
                  hasError ? 'text-red-700' : 'text-foreground'
                }`}>
                  {displayTitle}
                </p>
                {displaySubtitle && (
                  <p className={`text-[8px] break-words leading-tight ${
      ...
      <div className="absolute bottom-2 left-2.5 right-2.5">
        <div className="relative flex flex-row items-center gap-1 justify-between">
          <div className="flex flex-row gap-1 shrink min-w-0">
            <div className={`min-w-0 h-[18px] flex flex-row items-center justify-center gap-1 px-1 border shadow-sm rounded backdrop-blur-sm font-medium ${
              hasError 
