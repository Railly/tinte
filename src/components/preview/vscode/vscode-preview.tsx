...
export function VSCodePreview({ theme, className }: VSCodePreviewProps) {
  ...
  return (
    ...
    >
      {/* Title bar */}
      <div className="px-2 md:px-4 py-2 border-b flex items-center gap-2 bg-muted/50">
        <div className="flex gap-1">
          <div className="w-3 h-3 rounded-full bg-red-500" />
          <div className="w-3 h-3 rounded-full bg-yellow-500" />
          <div className="w-3 h-3 rounded-full bg-green-500" />
        </div>
        <div className="text-xs ml-1 md:ml-2 truncate hidden md:block">
        ...
        {viewMode === "split" && (
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="w-1/2 max-w-[50%] border-r border-border/50 flex flex-col overflow-hidden">
              <div className="px-2 py-1 border-b border-border/50 flex items-center gap-2 flex-shrink-0 bg-muted/30">
