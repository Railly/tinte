      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="bg-card border rounded-lg p-2">
          <div className="space-y-1.5">
            <p className="text-muted-foreground text-[10px]">Subscribe to newsletter</p>
            <Input
        ...
        <div className="bg-card border rounded-lg p-2">
          ...
          <div className="mt-1 h-6">
            <ChartContainer config={chartConfig} className="h-full w-full">
              <AreaChart data={miniData} margin={{ top: 2, right: 2, left: 2, bottom: 2 }}>
                <Area
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1.5">
            <div className="flex items-center space-x-1">
              ...
              <label htmlFor="demo-check" className="text-[8px] text-muted-foreground">
                Remember me
              </label>
            </div>
            <RadioGroup defaultValue="option1" className="flex items-center space-x-1">
              <RadioGroupItem value="option1" id="demo-radio" className="h-2.5 w-2.5" />
              <label htmlFor="demo-radio" className="text-[8px] text-muted-foreground">
                Option 1
              </label>
            </RadioGroup>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Button variant="secondary" size="sm" className="w-full h-4 text-[7px] py-0">
              Settings
            </Button>
          </div>
        </div>
