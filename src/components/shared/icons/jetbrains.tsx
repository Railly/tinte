...
export function JetBrainsIcon({ className }: JetBrainsIconProps) {
  return (
    <svg className={cn("w-4 h-4", className)} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 257">
      <defs>
        <linearGradient x1="25.2%" y1="43.3%" x2="99.2%" y2="67.4%" id="jetbrains-a">
          <stop stopColor="#FE2857" offset="21%"/>
          <stop stopColor="#293896" offset="100%"/>
        </linearGradient>
        <linearGradient x1="2.3%" y1="77.1%" x2="90.7%" y2="24.1%" id="jetbrains-b">
          <stop stopColor="#FE2857" offset="0%"/>
          <stop stopColor="#FE2857" offset="1%"/>
          <stop stopColor="#FF318C" offset="86%"/>
        </linearGradient>
        <linearGradient x1="6.3%" y1="13.9%" x2="94.6%" y2="87.7%" id="jetbrains-c">
          <stop stopColor="#FF318C" offset="2%"/>
          <stop stopColor="#FE2857" offset="21%"/>
          <stop stopColor="#FDB60D" offset="86%"/>
        </linearGradient>
        <linearGradient x1="91.1%" y1="27.7%" x2="2%" y2="68.6%" id="jetbrains-d">
          <stop stopColor="#FDB60D" offset="1%"/>
          <stop stopColor="#FCF84A" offset="86%"/>
        </linearGradient>
      </defs>
      <path d="M112.7 117.4 42 57.6a25.6 25.6 0 1 0-24.8 43.9h.3l.7.2 89 27.1a6 6 0 0 0 2 .4 6.4 6.4 0 0 0 3.3-11.8Z" fill="url(#jetbrains-a)"/>
      <path d="M126.8 18.7A18.6 18.6 0 0 0 98 3L11.8 55.4a25.6 25.6 0 1 0 30.6 41l77.3-63 .6-.5c4.1-3.6 6.5-8.7 6.5-14.2Z" fill="url(#jetbrains-b)"/>
      <path d="M252.2 131.5 121.4 5.5A18.6 18.6 0 1 0 96 32.8l.2.3 139 117a12.6 12.6 0 0 0 17-18.6Z" fill="url(#jetbrains-c)"/>
      <path d="M256 140.6a12.6 12.6 0 0 0-20-10.3L77.9 207.7a25.6 25.6 0 1 0 26.4 43.7l146.4-100.5c3.4-2.4 5.4-6.2 5.4-10.3Z" fill="url(#jetbrains-d)"/>
