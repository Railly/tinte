...
export type RadiusComputed = 'radius-sm'|'radius-md'|'radius-lg'|'radius-xl';
...
export const TOKEN_GROUPS = [
  { label:'Surface',   keys: ['background','foreground','card','card-foreground','popover','popover-foreground','border','input','ring'] as ColorToken[] },
  { label:'Primary',   keys: ['primary','primary-foreground'] as ColorToken[] },
  { label:'Secondary', keys: ['secondary','secondary-foreground','accent','accent-foreground','destructive','destructive-foreground'] as ColorToken[] },
  { label:'Text',      keys: ['muted','muted-foreground'] as ColorToken[] },
  { label:'Charts',    keys: ['chart-1','chart-2','chart-3','chart-4','chart-5'] as ColorToken[] },
  { label:'Sidebar',   keys: ['sidebar','sidebar-foreground','sidebar-primary','sidebar-primary-foreground','sidebar-accent','sidebar-accent-foreground','sidebar-border','sidebar-ring'] as ColorToken[] },
] as const;

export const NON_COLOR_GROUPS = {
  Fonts: ['font-sans','font-mono','font-serif'] as FontToken[],
  Radius: { editable: ['radius' as const], computed: ['radius-sm','radius-md','radius-lg','radius-xl'] as RadiusComputed[] },
  Shadows: ['shadow-2xs','shadow-xs','shadow-sm','shadow','shadow-md','shadow-lg','shadow-xl','shadow-2xl'] as ShadowToken[],
  Tracking: { editable: ['letter-spacing' as const], computed: ['tracking-tighter','tracking-tight','tracking-normal','tracking-wide','tracking-wider','tracking-widest'] as TrackingComputed[] },
};
