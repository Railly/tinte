...
export const FALLBACK_FONTS: FontInfo[] = [
  ...
  { family: "Outfit", category: "sans-serif", variants: ["100", "200", "300", "400", "500", "600", "700", "800", "900"], variable: true },
  ...
  { family: "Oxanium", category: "sans-serif", variants: ["200", "300", "400", "500", "600", "700", "800"], variable: true },
  { family: "Work Sans", category: "sans-serif", variants: ["100", "200", "300", "400", "500", "600", "700", "800", "900"], variable: true },
  ...
  { family: "Source Serif Pro", category: "serif", variants: ["200", "300", "400", "600", "700", "900"], variable: true },
  ...
  { family: "Cormorant", category: "serif", variants: ["300", "400", "500", "600", "700"], variable: true },
  ...
  // Display Fonts
  { family: "Space Grotesk", category: "display", variants: ["300", "400", "500", "600", "700"], variable: true },
  { family: "Clash Display", category: "display", variants: ["200", "300", "400", "500", "600", "700"], variable: true },
  { family: "Cabinet Grotesk", category: "display", variants: ["100", "200", "300", "400", "500", "600", "700", "800", "900"], variable: true },

  // Handwriting
  { family: "Architects Daughter", category: "handwriting", variants: ["400"], variable: false },
...
const sansSerifFontNames = FALLBACK_FONTS
  .filter(font => font.category === "sans-serif")
  .map(font => font.family);

const serifFontNames = FALLBACK_FONTS
  .filter(font => font.category === "serif")
  .map(font => font.family);

const monoFontNames = FALLBACK_FONTS
...
export function buildFontFamily(family: string, category: "sans-serif" | "serif" | "monospace" | "display" | "handwriting"): string {
...
export function waitForFont(family: string, weight: string = "400", timeout: number = 3000): Promise<void> {
