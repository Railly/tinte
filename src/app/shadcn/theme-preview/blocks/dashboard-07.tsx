...
export function Dashboard07() {
  return (
    <TooltipProvider>
      <div className="flex min-h-screen w-full flex-col rounded-md border bg-muted/40">
        <div className="flex flex-1">
          <aside className="inset-y-0 left-0 z-10 hidden w-14 flex-col rounded-l-md border-r bg-background sm:flex">
          ...
          <div className="flex w-full flex-col sm:gap-4 sm:py-4 sm:pl-14">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-4 rounded-t-md border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
              <Sheet>
