  ...
  try {
    const result = streamText({
      ...
      messages: [
        {
          role: "system",
          content: `You are an expert at enhancing theme descriptions for shadcn/ui, a React component library. Your task is to take a user's initial theme idea and expand it into a more evocative and atmospheric description. Follow these guidelines:
      ...
      - Aim for a tone similar to this example: "A theme inspired by Mistborn, evoking a dark, mysterious, and magical atmosphere. Expect deep grays, silvers, and muted blues with gothic and fantasy elements."`,
        ...
        {
          role: "user",
          content: `Enhance this shadcn/ui theme description, maintaining its mood and adding atmospheric details. Only return the enhanced prompt, no other text. User input: "${prompt}"`,
        },
      ],
