...
function generateCoreColors(
  ...
  return {
    ...
    "sidebar-ring": ring,
    surface: surface(bg, mode, 0.02),
    "surface-foreground": fg,
    code: surface(bg, mode, 0.02),
    "code-foreground": fg,
    "code-highlight": surface(bg, mode, 0.04),
    "code-number": pick(ramps.neutral, mode === "light" ? 500 : 400),
    selection: mode === "light" ? fg : tweakL(fg, -0.15),
