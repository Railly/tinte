...
export const editorColorMap = {
  ...
  // VS Code needs all sixteen ANSI slots. Leaving any of them out makes the
  // integrated terminal fall back to its defaults for those slots, so the
  // theme visibly stops applying there.
  "terminal.ansiBlack": "bg_2",
  "terminal.ansiRed": "sc",
  ...
  "terminal.ansiWhite": "tx_2",
  "terminal.ansiBrightBlack": "ui_3",
  "terminal.ansiBrightRed": "sc",
  "terminal.ansiBrightGreen": "ac_2",
  "terminal.ansiBrightYellow": "pr",
  "terminal.ansiBrightBlue": "sc",
  "terminal.ansiBrightMagenta": "ac_2",
  "terminal.ansiBrightCyan": "ac_2",
  "terminal.ansiBrightWhite": "tx",
