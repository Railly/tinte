...
export function Charts01({
  ...
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl w-full flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8 border rounded-md">
      ...
      <div className="grid w-full flex-1 gap-6">
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-6">
          ...
          <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-2">
            ...
            <ChartContainer config={chartConfig} className="ml-auto w-[64px]">
              <BarChart
                accessibilityLayer
                margin={{
                  left: 0,
