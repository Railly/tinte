...
export const AchievementBanner: React.FC = () => {
  return (
    <motion.div
      ...
      className="bg-gradient-to-r from-primary to-amber-100/50 text-primary-foreground py-2 px-4 text-center"
    >
      <p className="text-xs sm:text-sm font-medium flex flex-wrap justify-center items-center gap-1">
        ...
        <span className="inline-flex items-center">▲ Vercel</span>
        <span>x</span>
